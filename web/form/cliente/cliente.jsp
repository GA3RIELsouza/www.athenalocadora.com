...
<html lang="pt">
    ...
    <body>
        ...
        <form action="incluir_cliente.jsp" method="post" class="outer" id="formIncluir">
        ...
        <form action="alterar_cliente.jsp" method="post" class="outer" id="formAlterar">
        ...
        <form action="excluir_cliente.jsp" method="post" class="outer" id="formExcluir">
        ...
        <form action="consultar_cliente.jsp" method="post" class="outer" id="formConsultar">
